...
import com.qm.wxPay.pojo.v2.separate.account.Receivers;
import com.qm.wxPay.pojo.v2.separate.account.SeparateAccountBo;
import com.qm.wxPay.pojo.v2.separate.account.add.AddSeparateAccountBo;
import com.qm.wxPay.pojo.v2.separate.account.delete.DeleteSeparateAccountBo;
import com.qm.wxPay.pojo.v2.separate.account.delete.Receiver;
import com.qm.wxPay.pojo.v2.separate.account.returns.ReturnSeparateAccountBo;
import com.qm.wxPay.pojo.v2.separate.account.select.SelectSeparateAccountBo;
import com.qm.wxPay.pojo.v2.separate.account.select.fallback.result.SelectFallBackResultSeparateAccountBo;
import com.qm.wxPay.pojo.v2.separate.account.select.not.SelectNotSeparateAccountBo;
import com.qm.wxPay.pojo.v2.separate.account.success.SuccessSeparateAccountBo;
